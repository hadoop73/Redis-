...
##  二叉树
**`LCA` 问题**
* [236. Lowest Common Ancestor of a Binary Tree  ][25]
    * [4 lines C++/Java/Python/Ruby][26]
* [104. Maximum Depth of Binary Tree][27]
    * [root==null? 0 : Math.max(maxDepth(root.left), maxDepth(root.right))+1;][28]
* [110. Balanced Binary Tree][29]
    * [The bottom up O(N) solution would be better][30]
* [230. Kth Smallest Element in a BST][31]
    * [4 Lines in C++.][32]
    * 因为排序二叉树 `BST` 的中序是有序的，所以通过中序遍历，没遍历一个节点 `k--`；`k` 为 `0` 即为所求。
* [222. Count Complete Tree Nodes][33]
    * [easy short c++ recursive solution][34]
    * 如果左子树的高度和右子树的高度相等，可以直接利用公式 `(pow(2,h)-1)` 求解；高度不相等时，分为左子树和右子树分别求解。
* [124. Binary Tree Maximum Path Sum][35]
    * 返回左右子树的值，如果再加上 `root` 的 `value`，能够更新最后结果 `max`，则更新
    * 继续返回 `root` 的 `value` 和子树的值，其中有子树的值小于 0，则直接设置为 0，方便计算
    * [Accepted short solution in Java][36]
* [114. Flatten Binary Tree to Linked List ][37]
    * 把二叉树变成一个链表
    * [My short post order traversal Java solution for share][38]
    * 基于后序遍历，右子树先遍历，
* [106. Construct Binary Tree from Inorder and Postorder Traversal][39]
    * [A Python recursive solution][40]
...
## `MySQL`
  ...
  [26]: https://leetcode.com/discuss/45386/4-lines-c-java-python-ruby
  [27]: https://leetcode.com/problems/maximum-depth-of-binary-tree/
  [28]: https://leetcode.com/discuss/13341/simple-solution-using-java
  [29]: https://leetcode.com/problems/balanced-binary-tree/
  [30]: https://leetcode.com/discuss/22898/the-bottom-up-o-n-solution-would-be-better
  [31]: https://leetcode.com/problems/kth-smallest-element-in-a-bst/
  [32]: https://leetcode.com/discuss/43267/4-lines-in-c
  [33]: https://leetcode.com/problems/count-complete-tree-nodes/
  [34]: https://leetcode.com/discuss/38899/easy-short-c-recursive-solution
  [35]: https://leetcode.com/problems/binary-tree-maximum-path-sum/
  [36]: https://leetcode.com/discuss/14190/accepted-short-solution-in-java
  [37]: https://leetcode.com/problems/flatten-binary-tree-to-linked-list/
  [38]: https://leetcode.com/discuss/30719/my-short-post-order-traversal-java-solution-for-share
  [39]: https://leetcode.com/problems/construct-binary-tree-from-inorder-and-postorder-traversal/
  [40]: https://leetcode.com/discuss/28863/a-python-recursive-solution
  [41]: http://www.cnblogs.com/gw811/archive/2012/10/28/2743182.html
  [42]: http://foofish.net/blog/99/linklist-reverse
  [43]: http://blog.csdn.net/hackbuteer1/article/details/6914395
  [44]: http://www.nowcoder.com/practice/532d89889b974506a0805062fd1089fb?tpId=49&tqId=29307&rp=2&ru=/ta/2016test&qru=/ta/2016test/question-ranking
  [45]: http://www.nowcoder.com/profile/958037/codeBookDetail?submissionId=2061038
  [46]: http://www.nowcoder.com/question/next?pid=1725826&qid=44807&tid=3603591
  [47]: http://www.nowcoder.com/question/next?pid=1725826&qid=44805&tid=3602564
  [48]: http://www.nowcoder.com/question/next?pid=1725826&qid=44805&tid=3603591
  [49]: http://blog.csdn.net/morewindows/article/details/6709644
