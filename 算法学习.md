...
##  二叉树
**`LCA` 问题**
* [236. Lowest Common Ancestor of a Binary Tree  ][36]
    * [4 lines C++/Java/Python/Ruby][37]
* [104. Maximum Depth of Binary Tree][38]
    * [root==null? 0 : Math.max(maxDepth(root.left), maxDepth(root.right))+1;][39]
* [110. Balanced Binary Tree][40]
    * [The bottom up O(N) solution would be better][41]
* [230. Kth Smallest Element in a BST][42]
    * [4 Lines in C++.][43]
    * 因为排序二叉树 `BST` 的中序是有序的，所以通过中序遍历，没遍历一个节点 `k--`；`k` 为 `0` 即为所求。
* [222. Count Complete Tree Nodes][44]
    * [easy short c++ recursive solution][45]
    * 如果左子树的高度和右子树的高度相等，可以直接利用公式 `(pow(2,h)-1)` 求解；高度不相等时，分为左子树和右子树分别求解。
* [124. Binary Tree Maximum Path Sum][46]
    * 返回左右子树的值，如果再加上 `root` 的 `value`，能够更新最后结果 `max`，则更新
    * 继续返回 `root` 的 `value` 和子树的值，其中有子树的值小于 0，则直接设置为 0，方便计算
    * [Accepted short solution in Java][47]
* [114. Flatten Binary Tree to Linked List ][48]
    * 把二叉树变成一个链表
    * [My short post order traversal Java solution for share][49]
    * 基于后序遍历，右子树先遍历，
* [106. Construct Binary Tree from Inorder and Postorder Traversal][50]
    * [A Python recursive solution][51]
...
##  双指针
* [11. Container With Most Water][55]
	* [Simple and fast C++/C with explanation][56]
* [15. 3Sum][57]
	* [~20 lines. 68ms. c++ solution. Used two pointers similar to 2sum][58]
* [16. 3Sum Closest][59]
...
## `MySQL`
  ...
  [37]: https://leetcode.com/discuss/45386/4-lines-c-java-python-ruby
  [38]: https://leetcode.com/problems/maximum-depth-of-binary-tree/
  [39]: https://leetcode.com/discuss/13341/simple-solution-using-java
  [40]: https://leetcode.com/problems/balanced-binary-tree/
  [41]: https://leetcode.com/discuss/22898/the-bottom-up-o-n-solution-would-be-better
  [42]: https://leetcode.com/problems/kth-smallest-element-in-a-bst/
  [43]: https://leetcode.com/discuss/43267/4-lines-in-c
  [44]: https://leetcode.com/problems/count-complete-tree-nodes/
  [45]: https://leetcode.com/discuss/38899/easy-short-c-recursive-solution
  [46]: https://leetcode.com/problems/binary-tree-maximum-path-sum/
  [47]: https://leetcode.com/discuss/14190/accepted-short-solution-in-java
  [48]: https://leetcode.com/problems/flatten-binary-tree-to-linked-list/
  [49]: https://leetcode.com/discuss/30719/my-short-post-order-traversal-java-solution-for-share
  [50]: https://leetcode.com/problems/construct-binary-tree-from-inorder-and-postorder-traversal/
  [51]: https://leetcode.com/discuss/28863/a-python-recursive-solution
  [52]: http://www.cnblogs.com/pangxiaodong/archive/2011/05/27/2059547.html
  [53]: http://www.cnblogs.com/gw811/archive/2012/10/28/2743182.html
  [54]: http://foofish.net/blog/99/linklist-reverse
  [55]: https://leetcode.com/problems/container-with-most-water/
  [56]: https://discuss.leetcode.com/topic/16754/simple-and-fast-c-c-with-explanation
  [57]: https://leetcode.com/problems/3sum/
  [58]: https://discuss.leetcode.com/topic/15291/20-lines-68ms-c-solution-used-two-pointers-similar-to-2sum
  [59]: https://leetcode.com/problems/3sum-closest/
  [60]: http://blog.csdn.net/hackbuteer1/article/details/6914395
  [61]: http://www.nowcoder.com/practice/532d89889b974506a0805062fd1089fb?tpId=49&tqId=29307&rp=2&ru=/ta/2016test&qru=/ta/2016test/question-ranking
  [62]: http://www.nowcoder.com/profile/958037/codeBookDetail?submissionId=2061038
  [63]: http://www.nowcoder.com/question/next?pid=1725826&qid=44807&tid=3603591
  [64]: http://www.nowcoder.com/question/next?pid=1725826&qid=44805&tid=3602564
  [65]: http://www.nowcoder.com/question/next?pid=1725826&qid=44805&tid=3603591
  [66]: http://blog.csdn.net/morewindows/article/details/6709644
