...
* [3. Longest Substring Without Repeating Characters][23]
...
class Solution(object):
    def lengthOfLongestSubstring(self, s):
        ...
        return n
```
* [5. Longest Palindromic Substring][24]
	* [python O(n^2) method with some optimization, 88ms.][25]
	* 下一次比较，直接比较 maxlen 的子串，也就是一个优化
* [22. Generate Parentheses][26] 产生符合规则的括号对
	* [concise recursive C++ solution][27]
...
##  二叉树
**`LCA` 问题**
* [236. Lowest Common Ancestor of a Binary Tree  ][29]
    * [4 lines C++/Java/Python/Ruby][30]
* [104. Maximum Depth of Binary Tree][31]
    * [root==null? 0 : Math.max(maxDepth(root.left), maxDepth(root.right))+1;][32]
* [110. Balanced Binary Tree][33]
    * [The bottom up O(N) solution would be better][34]
* [230. Kth Smallest Element in a BST][35]
    * [4 Lines in C++.][36]
    * 因为排序二叉树 `BST` 的中序是有序的，所以通过中序遍历，没遍历一个节点 `k--`；`k` 为 `0` 即为所求。
* [222. Count Complete Tree Nodes][37]
    * [easy short c++ recursive solution][38]
    * 如果左子树的高度和右子树的高度相等，可以直接利用公式 `(pow(2,h)-1)` 求解；高度不相等时，分为左子树和右子树分别求解。
* [124. Binary Tree Maximum Path Sum][39]
    * 返回左右子树的值，如果再加上 `root` 的 `value`，能够更新最后结果 `max`，则更新
    * 继续返回 `root` 的 `value` 和子树的值，其中有子树的值小于 0，则直接设置为 0，方便计算
    * [Accepted short solution in Java][40]
* [114. Flatten Binary Tree to Linked List ][41]
    * 把二叉树变成一个链表
    * [My short post order traversal Java solution for share][42]
    * 基于后序遍历，右子树先遍历，
* [106. Construct Binary Tree from Inorder and Postorder Traversal][43]
    * [A Python recursive solution][44]
...
##  双指针
* [11. Container With Most Water][47]
	* [Simple and fast C++/C with explanation][48]
* [15. 3Sum][49]
	* [~20 lines. 68ms. c++ solution. Used two pointers similar to 2sum][50]
...
## `MySQL`
  ...
  [21]: https://leetcode.com/problems/decode-ways/
  ...
  [25]: https://leetcode.com/discuss/21332/python-o-n-2-method-with-some-optimization-88ms
  [26]: https://leetcode.com/problems/generate-parentheses/
  [27]: https://leetcode.com/discuss/14436/concise-recursive-c-solution
  [28]: https://leetcode.com/problems/decode-ways/
  [29]: https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree/
  [30]: https://leetcode.com/discuss/45386/4-lines-c-java-python-ruby
  [31]: https://leetcode.com/problems/maximum-depth-of-binary-tree/
  [32]: https://leetcode.com/discuss/13341/simple-solution-using-java
  [33]: https://leetcode.com/problems/balanced-binary-tree/
  [34]: https://leetcode.com/discuss/22898/the-bottom-up-o-n-solution-would-be-better
  [35]: https://leetcode.com/problems/kth-smallest-element-in-a-bst/
  [36]: https://leetcode.com/discuss/43267/4-lines-in-c
  [37]: https://leetcode.com/problems/count-complete-tree-nodes/
  [38]: https://leetcode.com/discuss/38899/easy-short-c-recursive-solution
  [39]: https://leetcode.com/problems/binary-tree-maximum-path-sum/
  [40]: https://leetcode.com/discuss/14190/accepted-short-solution-in-java
  [41]: https://leetcode.com/problems/flatten-binary-tree-to-linked-list/
  [42]: https://leetcode.com/discuss/30719/my-short-post-order-traversal-java-solution-for-share
  [43]: https://leetcode.com/problems/construct-binary-tree-from-inorder-and-postorder-traversal/
  [44]: https://leetcode.com/discuss/28863/a-python-recursive-solution
  [45]: http://www.cnblogs.com/gw811/archive/2012/10/28/2743182.html
  [46]: http://foofish.net/blog/99/linklist-reverse
  [47]: https://leetcode.com/problems/container-with-most-water/
  [48]: https://discuss.leetcode.com/topic/16754/simple-and-fast-c-c-with-explanation
  [49]: https://leetcode.com/problems/3sum/
  [50]: https://discuss.leetcode.com/topic/15291/20-lines-68ms-c-solution-used-two-pointers-similar-to-2sum
  [51]: http://blog.csdn.net/hackbuteer1/article/details/6914395
  [52]: http://www.nowcoder.com/practice/532d89889b974506a0805062fd1089fb?tpId=49&tqId=29307&rp=2&ru=/ta/2016test&qru=/ta/2016test/question-ranking
  [53]: http://www.nowcoder.com/profile/958037/codeBookDetail?submissionId=2061038
  [54]: http://www.nowcoder.com/question/next?pid=1725826&qid=44807&tid=3603591
  [55]: http://www.nowcoder.com/question/next?pid=1725826&qid=44805&tid=3602564
  [56]: http://www.nowcoder.com/question/next?pid=1725826&qid=44805&tid=3603591
  [57]: http://blog.csdn.net/morewindows/article/details/6709644
